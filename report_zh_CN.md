...
Cogentco在香港地区没有国内的ISP可以直连。电信、联通9929、移动和教育网会绕美，联通169则绕新加坡，详见Cogentco（美国）、Cogentco（新加坡）
...
值得一提的是，但是这是目前国内直连日本NTT延时很低且很稳定的渠道，CN2到日本NTT都干不过它，根据实测，目前NTT-9929点速度基本取决于用户接入的9929的带宽速度。
...
韩国本土网络发达，除了三大ISP以外还有地区性ISP，大陆地区前往韩国主要走TPE、APCN-2、NCP三大海缆。
...
KT（Koera Telecom），韩国最大电信运营商，市场占有率排名第一。

目前电信163/CN2和韩国KT之间的互联是通过APCN-2海缆完成的，因为APCN-2海缆只在上海有登陆，所以目前前往韩国KT都是走上海出口。需要注意的是，无论是电信163还是CN2和韩国KT的互联宽带均有限，高峰汇聚层没炸先Peer炸了也是经常发生的事情。
...
联通9929与KT有互联，同样也是走上海出口<!-- 看这个延时和只会走上海出口，联通9929很有可能走的也是APCN-2？存疑待查证 -->。高峰期几乎无丢包，延迟极低，单看极限最低延迟逼近沪韩IPLC；可惜经常抖动，虽然幅度不超过5ms。
速度方面也属于跟日本ISP到9929一样，KT到9929的速度取决于用户接入的9929带宽速度。
...
可直连骨干网：AS4134、AS4809、AS58453、～～AS4837～～

SKT可能从某种意义上知名度比KT高，SK Telecom是韩国最大的移动网络业务运营商。
实际上提供网络服务的是SKT的旗下公司SK Boardband。这一点可以从路由与ASN编号中看出。

CMI与SK Boardband在香港Peer，移动经香港到CMI可以与其直连。
-->
...
DACOM全名为DataCommunication，由韩国政府牵头，LG与三星共同投资建设，但拥有独立经营权的ISP<!--因为三星和乐金平分了股份-->，后因为LG额外注资增持股份，LG完全接管DACOM。<!-- 莫非三星现在的网络是后来独自建的？-->而LG Telecom则是LG自己独自投资建设的移动网络。

LG到联通9929是直连，走上海出口。但奇特的是虽然延迟也很低，速度却非常不稳定，隔三差五就突发性的延时起飞；但是正常的时候又十分平稳，几乎没有抖动，可速度依旧不尽人意。
